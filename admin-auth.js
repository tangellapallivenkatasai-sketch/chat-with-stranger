...
auth.onAuthStateChanged((user) => {
    ...
    const emailElement = document.getElementById("admin-account-email");
    if (emailElement) {
...
const topSignOutBtn = document.getElementById("topbar-signout-btn");
if (topSignOutBtn) {
    topSignOutBtn.addEventListener("click", () => auth.signOut());
}
